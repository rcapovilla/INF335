...
public class Brecho {
	...
	public static void main(String[] args) {
		...
		produtos.add(nProg);*/
		//condições acima não adicionariam os produtos corretamente, mas sim iria sobrescrever um sobre o outro
		ProdutoBean nProg = new ProdutoBean("CD00001","Celular Galaxy S10", "128 Gb, Preto, com Carregador",1250.0,"Poucos riscos, estado de novo.");
		produtos.add(nProg);
		nProg = new ProdutoBean("CD00002","Prod 2 ...", "Bla Bla Bla",1100.0,"Bla Bla Bla");
		produtos.add(nProg);
		...
		// Imprime produtos
		for (int i=0; i<=produtos.size(); i++) {//condição de início errada, alterado de 1 para 0
		...
		// Calcula Média
		Double media = 0.0;
		int i = 0;//condição de início errada, alterado de 1 para 0
